...
| `API_SERVER_REVIEW_REPO_ROOT` | Optional repo root for review/control endpoints exposed by the API server. When set, Hermes can proxy repo-native review/governance commands through dedicated review endpoints. |
